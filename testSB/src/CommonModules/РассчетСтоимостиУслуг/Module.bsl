...
// Записать стоимость обработки хаб.
// 
// Параметры:
//  Документ - ДокументСсылка.ЗагрузкаДанных - Документ
//  ИмяФайла - Строка - Имя файла
//  МесяцыОтгрузки - Соответствие из Дата  - Месяцы отгрузки
...
// Записать стоимость хранения.
// 
// Параметры:
//  Документ - ДокументСсылка.ЗагрузкаДанных - Документ
//  ИмяФайла - Строка - Имя файла
//  МесяцыОтгрузки - Соответствие из Дата - Месяцы отгрузки
//  ТаблицаДиапазонов - ТаблицаЗначений - Таблица диапазонов
...
// 
// Параметры:
//  Строка - Неопределено, Строка - Строка
//  ОжидаемоеКолВоПолей - Число - Ожидаемое кол во полей
// 
// Возвращаемое значение:
//  Структура - Прочитать поля:
// * Дата_Убытие - Строка -
// * Время_Убытие - Строка -
// * НомерГрузовогоМеста - Строка -
// * ЗаказКлиента - Строка -
// * ИдентификаторЕдиницыОбработки - Строка -
// * ОтпСклМс - Строка -
// * Дата_Прибытие - Строка -
// * Время_Прибытие - Строка -
// * КодТипаОбработки - Строка -
...
// Заполнить дни хранения.
// 
// Параметры:
//  ТаблицаДиапазонов - ТаблицаЗначений - Таблица диапазонов
// 
// Возвращаемое значение:
//  ТаблицаЗначений - Заполнить дни хранения
