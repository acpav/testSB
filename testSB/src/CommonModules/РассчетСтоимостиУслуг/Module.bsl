...
Процедура ЗаписатьСтоимостьОбработкиХаб(Документ, ИмяФайла, Знач МесяцыОтгрузки) Экспорт 
	...
	Сообщить("Время записи стоимость сортировки Хаб:" + Строка(ТекущаяУниверсальнаяДатаВМиллисекундах() - ВремяНачала));	
...
Процедура ЗаписатьСтоимостьОбработки(Документ, ИмяФайла, Знач МесяцыОтгрузки) Экспорт
	...
	Сообщить("Время записи стоимость сортировки:" + Строка(ТекущаяУниверсальнаяДатаВМиллисекундах() - ВремяНачала));	
...
Процедура ЗаписатьСтоимостьХранения(Документ, ИмяФайла, Знач МесяцыОтгрузки, Знач ТаблицаДиапазонов) Экспорт
	...
	Сообщить("Время записи стоимость хранения:" + Строка(ТекущаяУниверсальнаяДатаВМиллисекундах() - ВремяНачала));	
